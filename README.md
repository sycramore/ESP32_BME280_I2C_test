...
## Development notes
Initial code scaffold was generated with ChatGPT. I2C addresses, WHO_AM_I register values, and chip ID discrepancies (see above) were verified through datasheet research and hands-on testing.
